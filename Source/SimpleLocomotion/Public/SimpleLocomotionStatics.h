...
public:
	...
	UFUNCTION(BlueprintPure, Category=Animation, meta=(BlueprintThreadSafe))
	static FGameplayTag GetSimpleOppositeCardinal(const FGameplayTag& Cardinal);
	...
	UFUNCTION(BlueprintPure, Category=Animation, meta=(Categories="Simple.Mode", BlueprintThreadSafe))
	static UAnimSequence* GetSimpleAnimation(const FSimpleLocomotionSet& LocomotionSet, FGameplayTag Cardinal, bool& bValid);
};
